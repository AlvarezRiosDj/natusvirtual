            ...
            <div class="row align-items-center">
                <div class="col-12 col-md-6">
                    <div class="video-content-area pr-3 mb-100">
                        <img src="assets/public/img/bg-img/4.jpg" alt="">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6">
                    <div class="single-team-member-area d-flex align-items-center mb-30">
                        ...
                        <div class="team-thumbnail">
                            <img src="assets/public/img/bg-img/6.jpg" alt="">
                        </div>
                        <!-- Team Content -->
                ...
                <div class="col-12 col-sm-6">
                    <div class="single-team-member-area d-flex align-items-center mb-30">
                        <!-- Team Thumbnail -->
                        <div class="team-thumbnail">
                            <img src="assets/public/img/bg-img/7.jpg" alt="">
                        </div>
                        <!-- Team Content -->
                        <div class="team-content">
                            <h5>Jason Curry</h5>
                ...
                <div class="col-12 col-sm-6">
                    <div class="single-team-member-area d-flex align-items-center mb-30">
                        <!-- Team Thumbnail -->
                        <div class="team-thumbnail">
                            <img src="assets/public/img/bg-img/8.jpg" alt="">
                        </div>
                        <!-- Team Content -->
                        <div class="team-content">
                ...
                <div class="col-12 col-sm-6">
                    <div class="single-team-member-area d-flex align-items-center mb-30">
                        <!-- Team Thumbnail -->
                        <div class="team-thumbnail">
                            <img src="assets/public/img/bg-img/9.jpg" alt="">
                        </div>
                        <!-- Team Content -->
                        <div class="team-content">
                            <h5>Lola Gill</h5>
                ...
                <div class="col-12">
                    <div class="testimonial-slide owl-carousel">
                        ...
                        <div class="single-testimonial-area">
                            ...
                            <div class="testimonial-thumbnail-title d-flex align-items-center">
                                <div class="testimonial-thumbnail">
                                    <img src="assets/public/img/bg-img/10.jpg" alt="">
                                </div>
                        ...
                        <div class="single-testimonial-area">
                            ...
                            <div class="testimonial-thumbnail-title d-flex align-items-center">
                                <div class="testimonial-thumbnail">
                                    <img src="assets/public/img/bg-img/11.jpg" alt="">
                                </div>
                                <div class="testimonial-title">
                                    <h5>Roy Long</h5>
                        ...
                        <div class="single-testimonial-area">
                            ...
                            <div class="testimonial-thumbnail-title d-flex align-items-center">
                                <div class="testimonial-thumbnail">
                                    <img src="assets/public/img/bg-img/12.jpg" alt="">
                                </div>
                                <div class="testimonial-title">
                                    <h5>Stephen Colon</h5>
                        ...
                        <div class="single-testimonial-area">
                            ...
                            <div class="testimonial-thumbnail-title d-flex align-items-center">
                                <div class="testimonial-thumbnail">
                                    <img src="assets/public/img/bg-img/13.jpg" alt="">
                                </div>
                                <div class="testimonial-title">
                                    <h5>Kevin Castro</h5>
